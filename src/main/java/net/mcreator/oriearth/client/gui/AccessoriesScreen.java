...
public class AccessoriesScreen extends AbstractContainerScreen<AccessoriesMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("oriearth:textures/screens/accessories.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Oriearth Accessories", 36, 7, -12829636);
	}
